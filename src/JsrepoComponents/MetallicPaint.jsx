...
export function parseLogoImage(file) {
  ...
  return new Promise((resolve, reject) => {
    ...
    img.onload = function () {
      ...
      // For SVGs, naturalWidth/naturalHeight may be 0, so use default size
      let width = img.naturalWidth || MAX_SIZE;
      let height = img.naturalHeight || MAX_SIZE;

      // If SVG has no intrinsic dimensions, use square canvas
    ...
    img.onerror = (e) => {
      console.error("[MetallicPaint] Image load failed", e);
